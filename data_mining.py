'''
This will scrape all data from Drug Tests category
Popular Lab Tests (Urine) Sub section
Parse the 5 Panel Drug Test (Finds all clinics)
...
#####################################
    ...
    # Sometimes the try Alert clause wont find the popup
        ...
        df.to_csv('userpath.csv', mode = 'a', index=False)
